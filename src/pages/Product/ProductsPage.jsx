...
const ProductsPage = () => {
  ...
  const [currentPage, setCurrentPage] = useState(0); // backend 0-indexed
  ...
  const priceRanges = [
    ...
    {
      label: "Từ 10.000₫ - 50.000₫",
      min: 10000,
      max: 50000,
      value: "10000-50000",
    },
    {
      label: "Từ 50.000₫ - 100.000₫",
      min: 50000,
      max: 100000,
      value: "50000-100000",
    },
    ...
    { label: "Trên 1 triệu", min: 1000000, max: null, value: "1000000-null" },
  ];

  // Lấy danh mục nổi bật (4 sản phẩm thuộc "Bánh Ngọt")
  useEffect(() => {
      ...
      try {
        ...
        if (
          ...
          if (selectedCategory !== "All") {
            // Nếu cần lọc thêm category
            response.content = Array.isArray(response.content)
              ? response.content.filter((p) => p.category === selectedCategory)
              : [];
          }
    ...
    <div className="products-page">
      ...
      <section className="highlight-categories container">
        <div className="highlight-grid">
          {Array.isArray(highlightCategories) &&
            ...
            highlightCategories.map((cat, index) => (
              ...
              >
                ...
                <h3>{cat.name}</h3>
                <Link to="#" className="btn-small-outline">
                  Xem ngay
                </Link>
              </div>
            ))}
      ...
      <div className="main-products-content container">
        ...
        <div className="product-list-content">
          ...
          <div className="sort-options">
            ...
            <button
              className={`sort-btn ${
                sortBy === "name" && sortDirection === "asc" ? "active" : ""
              }`}
