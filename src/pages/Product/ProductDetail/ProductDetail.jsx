...
const ProductDetail = () => {
  ...
  useEffect(() => {
    ...
    if (productId) {
      // Đảm bảo productId có giá trị trước khi fetch
      fetchProduct();
    } else {
      setLoading(false);
      ...
      <div className="product-detail-page">
          ...
          <div className="product-info">
                  ...
                  <p className="save-amount">
                    ...
                    <span>
                      {new Intl.NumberFormat("vi-VN", {
                        style: "currency",
                        currency: "VND",
                      }).format(product.oldPrice - product.price)}
                    </span>
                  </p>
                </>
              )}
            ...
            <div className="product-actions">
              ...
              >
                ...
                {isInWishlist ? "Đã trong Yêu thích" : "YÊU THÍCH"}
            ...
            <div className="promotions-section">
              <h3>
                <i className="fas fa-gift"></i> Khuyến mãi đặc biệt!!!
              </h3>
              <ul>
        ...
        <div className="policy-list">
          <div className="policy-item">
            <div className="policy-icon policy-icon-freeship"></div>{" "}
            {/* Thẻ div mới */}
          ...
          <div className="policy-item">
            <div className="policy-icon policy-icon-return"></div>{" "}
            {/* Thẻ div mới */}
          ...
          <div className="policy-item">
            <div className="policy-icon policy-icon-support"></div>{" "}
            {/* Thẻ div mới */}
          ...
          <div className="policy-item">
            <div className="policy-icon policy-icon-payment"></div>{" "}
            {/* Thẻ div mới */}
